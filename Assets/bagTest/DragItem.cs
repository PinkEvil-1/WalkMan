...
public class DragItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (curEnter == null)
        {
            ...
            myTransform.transform.localPosition = Vector3.zero;
        }
        else
        {
            //移动至物品格子上
            if (curEnter.name == "UI_ItemGrid")
            {
                ...
                Transform targetGird = curEnter.transform;
                transform.parent = targetGird;
            ...
            else
            {
                ...
                if (curEnter.name == eventData.pointerDrag.name && curEnter != eventData.pointerDrag)
                {
                    /*  Vector3 targetPostion = curEnter.transform.position;
                      ...
                      originalPosition = myTransform.position;*/
                    Transform targetGird = curEnter.transform.parent;
                    curEnter.transform.parent = originalParent;
                    transform.parent = targetGird;
                    curEnter.transform.localPosition = Vector3.zero;
